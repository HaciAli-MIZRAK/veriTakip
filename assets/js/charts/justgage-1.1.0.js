 ...
 * -----------------------------
 ...
 JustGage = function(config, xcolor) {
  ...
  obj.config =
  {
    ...
    titleFontColor : obj.kvLookup('titleFontColor', config, dataset,  "#000000"),
...
//bar color burası
    ...
    levelColors : obj.kvLookup('levelColors', config, dataset, xcolor, 'array', ','),
